...
avx-test:
	(cd ctest; make $(patsubst %, avx-instruction-selection-%, 16 15 14 13 12 11 10 9 8 6.0 5.0 4.0 3.9))
...
raw-modules:	$(patsubst %, src/%/LLVM/Raw/Core.hsc, 16 15 14 13 12 11 10 9 8 7 6.0 5.0 4.0 3.9)
